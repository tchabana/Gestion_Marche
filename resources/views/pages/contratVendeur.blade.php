        ...
        <div class="card-body">
            <form method="POST" action="{{ route('contrat') }}" autocomplete="on" novalidate enctype="multipart/form-data">
                ...
                <div class="form-group{{ $errors->has('libelle') ? ' has-danger' : '' }}">
                    ...
                    <select type="text" name="libelle" id="input-name"
                ...
                <div class="form-group{{ $errors->has('place') ? ' has-danger' : '' }}">
                    ...
                    <select type="text" name="place" id="input-name"
                        class="form-control{{ $errors->has('place') ? ' is-invalid' : '' }}" required autofocus>
                ...
                <div class="form-group{{ $errors->has('prixad') ? ' has-danger' : '' }}">
                    ...
                    <input type="text" id="disabledTextInput" class="form-control" name="prixad"
                        placeholder="Le prix est choisi automatiquement">
                </div>
